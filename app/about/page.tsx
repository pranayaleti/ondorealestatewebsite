      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl font-semibold mb-4 dark:text-foreground">Our Mission</h2>
            <p className="mb-8 dark:text-muted-foreground">
            ...
            <h2 className="text-2xl font-semibold mb-4 dark:text-foreground">Our Team</h2>
            <p className="mb-8 dark:text-muted-foreground">
            ...
            <h2 className="text-2xl font-semibold mb-4 dark:text-foreground">Our Coverage Area</h2>
            <p className="mb-8 dark:text-muted-foreground">
            ...
            <div className="text-center mt-12">
              <h3 className="text-2xl font-semibold mb-4 dark:text-foreground">Ready to work with us?</h3>
