...
const mockCompanies = [
  ...
  },
  {
    ...
    phone: "(801) 555-5678",
    email: "hello@premierpropertysolutions.com",
  ...
  },
  {
    ...
    phone: "(801) 555-9012",
    email: "info@commercialpropertyexperts.com",
  ...
  },
  {
    ...
    phone: "(801) 555-3456",
    email: "support@residentialmanagementgroup.com",
    specialties: ["single-family", "multi-family"],
  ...
  },
  {
    ...
    phone: "(801) 555-7890",
    email: "concierge@luxurypropertyservices.com",
  ...
  },
  {
    ...
    phone: "(801) 555-2345",
    email: "team@mountainviewmanagement.com",
          ...
          <Card key={property.id} className="overflow-hidden hover:shadow-lg transition-shadow duration-200">
            <div className="relative h-48 w-full">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[var(--gradient-from)]/70 to-transparent p-4">
                ...
                <p className="text-foreground/90 text-sm">{property.address}</p>
              </div>
            </div>
