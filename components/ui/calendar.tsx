    ...
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          captionLayout === 'label'
            ? 'text-sm'
            : 'rounded-md pl-2 pr-1 flex items-center gap-1 text-sm h-8 [&>svg]:text-foreground/70 [&>svg]:size-3.5',
          defaultClassNames.caption_label
        ),
        table: 'w-full border-collapse',
        weekdays: cn('flex', defaultClassNames.weekdays),
        weekday: cn(
          'text-foreground/70 rounded-md flex-1 font-normal text-[0.8rem] select-none',
        ...
        week_number: cn(
          'text-[0.8rem] select-none text-foreground/70',
        ...
        outside: cn(
          'text-foreground/70 aria-selected:text-foreground/70',
